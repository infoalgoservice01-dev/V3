...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "relative rounded-md border bg-white dark:bg-slate-900 p-3 text-slate-950 dark:text-slate-50 shadow-md animate-in fade-in-0 zoom-in-95",
        className
      )}
    >
      {closeButton && (
        <button
          type="button"
          onClick={handleClose}
          className="absolute top-1 right-1 z-10 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2"
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "rounded-md bg-slate-900 dark:bg-white px-2 py-1 text-xs text-slate-50 dark:text-slate-900 shadow-md animate-in fade-in-0 zoom-in-95",
        className
      )}
    >
      {children}
  ...
  return (
    <div
      className={cn(
        ...
        "text-[10px] font-medium text-slate-950 dark:text-slate-50",
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col rounded-md border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm overflow-hidden [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-slate-200 dark:[&>button:not(:last-child)]:border-slate-800">
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex items-center justify-center size-8 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors",

...
// 2. Standalone Typography Layout (without background override)
export function HeroGeometricContent({
...
// 3. Combined Wrapper Component (Legacy Match)
    ...
    children?: React.ReactNode;
     ...
     return (
        <div className="relative w-full h-full">
            <HeroBackground />
            <HeroGeometricContent badge={badge} title1={title1} title2={title2}>
                {children}
